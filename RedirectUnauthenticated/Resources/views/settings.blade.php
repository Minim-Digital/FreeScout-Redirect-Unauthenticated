    ...
    <div class="col-xs-12">
        <form class="form-horizontal margin-top margin-bottom" method="POST" action="" autocomplete="off" id="eup-widget-form">
            ...
            <div class="form-group">
                <div class="col-sm-6 col-sm-offset-2">
                    <label class="checkbox">
                        <input type="checkbox" name="redirect_unauthenticated_users" value="1" @if ($redirect_unauthenticated_users ?? false) checked="checked" @endif />
                        {{ __('Redirect unauthenticated users to login page') }}
                    </label>
                    <p class="help-block">
